...
const ProductBox = ({ style = "vertical", product, boxStyle }) => {
  ...
  return (
    ...
    //     />
    //   ) : style == "vertical" && variant == "product_box_two" ? (
    //     <ProductBox2
    //       productState={productState}
    //       setProductState={setProductState}
    //     />
    //   ) : style == "vertical" && variant == "product_box_three" ? (
    //     <ProductBox3
    //       productState={productState}
    //       setProductState={setProductState}
    //     />
    //   ) : style == "vertical" && variant == "product_box_four" ? (
    //     <ProductBox4 productState={productState} />
    //   ) : style == "vertical" && variant == "product_box_five" ? (
    //     <ProductBox5
    //       productState={productState}
    //       setProductState={setProductState}
    //     />
    //   ) : style == "vertical" && variant == "product_box_six" ? (
    //     <ProductBox6 productState={productState} />
    //   ) : style == "vertical" && variant == "product_box_seven" ? (
    //     <ProductBox7 productState={productState} />
    //   ) : style == "vertical" && variant == "product_box_eight" ? (
    //     <ProductBox8 productState={productState} />
    //   ) : style == "vertical" && variant == "product_box_nine" ? (
    //     <ProductBox9
    //       productState={productState}
    //       setProductState={setProductState}
    //     />
    //   ) : style == "vertical" && variant == "product_box_ten" ? (
    //     <ProductBox10 productState={productState} />
    //   ) : style == "vertical" && variant == "product_box_eleven" ? (
    //     <ProductBox11
    //       productState={productState}
    //       setProductState={setProductState}
    //     />
    //   ) : style == "vertical" && variant == "product_box_twelve" ? (
    //     <ProductBox12
    //       setProductState={setProductState}
    //       productState={productState}
    //     />
